...
import at.fhooe.im.minimine.meshbuilder.MiniMineMeshGenerator;
...
public class WorldRenderer2 {
	...
	private MiniMineMeshGenerator cmg;
	 ...
	 */
	public WorldRenderer2(World _world, int maxBuffer) {
		if(maxBuffer > 15) {
			maxBuffer = 15;
		}
